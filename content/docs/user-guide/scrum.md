...
1.  创建卡片  
    ...
    ![创建活动](assets/敏捷管理/创建活动.png)

    ![创建任务](assets/敏捷管理/创建任务.png)

    ![创建用户故事](assets/敏捷管理/创建用户故事.png)
...
1. 未规划区的使用
    ...
    ![未规划区入口](assets/敏捷管理/未规划区入口.png)

    ![未规划区展开界面](assets/敏捷管理/未规划区展开界面.png)
...
1. 数据统计
    ...
    ![数据统计](assets/敏捷管理/数据统计.png)

    ![数据分析结果展示](assets/敏捷管理/数据分析结果展示.png)
...
1. 进入冲刺相关操作
    ...
    - 创建缺陷
      ...
      ![冲刺详情](assets/敏捷管理/冲刺详情.png)
    - 筛选
      
      可以对故事，任务和缺陷进行分类筛选。
      
      ![冲刺筛选](assets/敏捷管理/冲刺筛选.png)
    - 操作
      
      可以把导入冲刺的故事移除，移除后不会在故事地图里面删除，只是故事地图中的卡片颜色会变为未导入状态。也可以导入到其他冲刺中。
      
      ![冲刺移除操作](assets/敏捷管理/冲刺移除操作.png)
...
1.  选择模板
    ...
    ![看板模板](assets/敏捷管理/看板模板.png)  

    ![模板详情](assets/敏捷管理/模板详情.png)
...
1.  使用看板
   ...
   - 创建卡片
     ...
     ![创建卡片](assets/敏捷管理/创建卡片.png)
    
     ![卡片详情编辑界面](assets/敏捷管理/卡片详情编辑界面.png)
