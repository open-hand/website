...
## 创建合并请求
  ...
  点击 `创建合并请求`按钮![创建合并请求](/docs/user-guide/development-pipeline/image/create-mergeRequest.png) ，浏览器新开页面，链接至GitLab新建合并请求界面。在GitLab进行相关操作后，平台会请求相关数据，合并请求列表数据将更新。