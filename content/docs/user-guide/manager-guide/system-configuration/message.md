...
1. 点击您要修改的站内信模板所在列的![三点](/docs/user-guide/manager-guide/image/more-vert.png)按钮，选择`修改`，进入修改模板页。
2. 您可以在修改模板页，对站内信的主题、内容进行修改。
3. (可选)你可以设置当前模板是否为默认使用模板。
4. 点击保存，保存对模板的修改。

### 删除模板

点击您要删除的站内信模板所在列的![三点](/docs/user-guide/manager-guide/image/more-vert.png)按钮，选择`删除`，即可删除模板。
...
1. 进入平台管理，点击菜单“设置>通知>消息服务”，进入消息服务页面。
2. 点击您要进行设置的消息类型所在列的![三点](/docs/user-guide/manager-guide/image/more-vert.png)按钮，选择`设置短信内容`，进入该消息类型的设置短信内容页。
3. 在设置短信内容页，您可以看到可使用短信模板（短信没有发送设置）。

    选择模板：
    - 模板列表展示了当前消息类型下的全部模板。点击模板名称查看模板。您可以点击![三点](/docs/user-guide/manager-guide/image/more-vert.png)，选择`设为默认模板`，设置默认发送的短信模板。
6. 点击点击操作栏的创建模板→![创建模板](/docs/user-guide/manager-guide/image/add-messagetem.png)按钮，打开新建短信模板页面。
...
1. 点击您要修改的短信模板所在列的![三点](/docs/user-guide/manager-guide/image/more-vert.png)按钮，选择`修改`，进入修改模板页。
2. 您可以在修改模板页，对短信的内容进行修改。
3. (可选)你可以设置当前模板是否为默认使用模板。
4. 点击保存，保存对模板的修改。

### 删除模板

点击您要删除的短信模板所在列的![三点](/docs/user-guide/manager-guide/image/more-vert.png)按钮，选择`删除`，即可删除模板。
