...
<blockquote class="warning">
  <ul>
  <li>1.本安教程基于NFS存储进行搭建</li>
  <li>2.安装时请逐个确认每个变量</li>
  <li>3.请确认所有域名是否已映射到将要部署的集群中</li>
  <li>4.请注意所有创建PV的目录都是基于NFS Server主机的根目录，并非mount到的主机上的根目录，请清楚之间的关系，NFS相关信息请参考<a href="./base/nfs" target="_blank">这里</a></li>
