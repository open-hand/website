...
在0.22版本更换框架为hzero框架，对c7n服务进行了拆分了重构，服务列表如下：
</blockquote>

|   原服务名  | 新服务名  |原数据库|新数据库|
|  ----  | ----  |  ----  | ----  |
|api-gateway	|hzero-gateway|base-service|hzero-platform|
|oauth-server	|hzero-oauth|base-service|hzero-platform|
|go-register-server	|hzero-register|-|-|
|asgard-service	|hzero-asgard|asgard-service|asgard-service|
|file-service	|hzero-file|-|hzero-file|
|notify-service|	hzero-message|notify-service|hzero-message|
|manager-service|	hzero-admin|manager-service|hzero-admin|
|base-service|	hzero-iam|base-service|hzero-platform|
|base-service|	hzero-platform|base-service|hzero-platform|
...
env:
  open:
    ...
    SPRING_DATASOURCE_ASGARD_SERVICE_URL: jdbc:mysql://localhost:3306/asgard_service?useUnicode=true&characterEncoding=utf-8&useSSL=false&zeroDateTimeBehavior=convertToNull&useInformationSchema=true&remarks=true&serverTimezone=Asia/Shanghai
    SPRING_DATASOURCE_ASGARD_SERVICE_USERNAME: root
    # 原base-service 数据库
    SPRING_DATASOURCE_BASE_C7N_PASSWORD: password
    SPRING_DATASOURCE_BASE_C7N_URL: jdbc:mysql://localhost:3306/base_service?useUnicode=true&characterEncoding=utf-8&useSSL=false&useInformationSchema=true&remarks=true&serverTimezone=Asia/Shanghai
    SPRING_DATASOURCE_BASE_C7N_USERNAME: root
    # 初始化脚本地址 不用指定特定数据库 ip只向hzero_...数据库
    SPRING_DATASOURCE_C7N_PASSWORD: password
    SPRING_DATASOURCE_C7N_URL: jdbc:mysql://localhost:3306/?useUnicode=true&characterEncoding=utf-8&useSSL=false&useInformationSchema=true&remarks=true&serverTimezone=Asia/Shanghai
    SPRING_DATASOURCE_C7N_USERNAME: root
    # 新hzero_message 数据库
    SPRING_DATASOURCE_HZERO_MESSAGE_PASSWORD: password
    SPRING_DATASOURCE_HZERO_MESSAGE_URL: jdbc:mysql://localhost:3306/hzero_message?useUnicode=true&characterEncoding=utf-8&useSSL=false&zeroDateTimeBehavior=convertToNull&useInformationSchema=true&remarks=true&serverTimezone=Asia/Shanghai
    SPRING_DATASOURCE_HZERO_MESSAGE_USERNAME: root
    # 新hzero_platform 数据库 
    SPRING_DATASOURCE_HZERO_PLATFORM_PASSWORD: password
    SPRING_DATASOURCE_HZERO_PLATFORM_URL: jdbc:mysql://localhost:3306/hzero_platform?useUnicode=true&characterEncoding=utf-8&useSSL=false&useInformationSchema=true&remarks=true&serverTimezone=Asia/Shanghai
    SPRING_DATASOURCE_HZERO_PLATFORM_USERNAME: root
    # 原notify_service 数据库
    SPRING_DATASOURCE_NOTIFY_C7N_PASSWORD: password
    SPRING_DATASOURCE_NOTIFY_C7N_URL: jdbc:mysql://localhost:3306/notify_service?useUnicode=true&characterEncoding=utf-8&useSSL=false&useInformationSchema=true&remarks=true&serverTimezone=Asia/Shanghai
    SPRING_DATASOURCE_NOTIFY_C7N_USERNAME: root
...
- 升级服务
    ...
    helm upgrade --install hzero-asgard c7n/hzero-asgard \
        -f <(helm get values hzero-asgard) \
        --version 0.22.0
    ```
