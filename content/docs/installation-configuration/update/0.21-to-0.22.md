...
在0.22版本更换框架为hzero框架，对c7n服务进行了拆分了重构，c7n原框架服务替换为hzero框架对应服务，数据库也进行了相应更换。同时，此版本也将helm2升级到helm3，后续不再支持helm2。
</blockquote>
...
菜单数据初始化使用preJob.preInitDB.datasources.platform.xxx。
</blockquote>
### 升级 agile service
