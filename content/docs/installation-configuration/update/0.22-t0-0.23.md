...
- 升级gitlab-service
    ...
    helm upgrade gitlab-service c7n/gitlab-service \
        --reuse-values \
        --set env.open.EUREKA_CLIENT_SERVICEURL_DEFAULTZONE=http://choeorodon-register.c7n-system:8000/eureka/ \
...
- 升级devops-service:
    ...
    helm upgrade devops-service c7n/devops-service \
        ...
        --set env.open.EUREKA_CLIENT_SERVICEURL_DEFAULTZONE=http://choeordon-register.c7n-system:8000/eureka/ \
        --set AGENT_VERSION=0.23.2
...
- 升级服务
    ...
    helm upgrade choerodon-front c7n/choerodon-front \
        --reuse-values \
        --set outward=/knowledge/share,/iam/register-organization,/iam/invite-user,/agile/backlog-share
        --version 0.23.0 \
        --namespace c7n-system
    ```
