...
## [最新更新日志](https://choerodon.gitee.io/choerodon-ui/zh/docs/other/CHANGELOG)
...
- 🌟 默认 ant 前缀改为 c7n，如要使用 ant 前缀，请[修改主题变量@c7n-prefix](https://choerodon.github.io/choerodon-ui/docs/react/customize-theme-cn)，并使用[全局化配置](https://choerodon.github.io/zh/procmp/configure/configure)。
