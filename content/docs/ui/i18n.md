...
choerodon-ui 提供了一个 React 组件 [LocaleProvider](../components/other/locale-provider) 用于全局配置国际化文案。
...
具体的使用方法和新语言包贡献方式请参考 [LocaleProvider 文档](../components/other/locale-provider)。
