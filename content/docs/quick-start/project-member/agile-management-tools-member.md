...
**第一步：** 点击`创建问题`，选择问题类型，输入问题概要即可快速[创建问题](../../../user-guide/agile/backlog/create-issue/)。(路径：待办事项 > 创建问题)
...
### 创建看板
 ...
 - 点击页面上方的`创建看板`，输入相应的看板名称即可快速[创建看板](../../../user-guide/agile/sprint/create-kanban/)。(路径：活跃冲刺 > 创建看板)
...
**第二步：** 点击此处创建分支，过选择应用、分支来源，修改分支类型及分支名称，即可为该问题创建关联的分支。(路径：问题详情 > 开发 > 创建分支)
